...
(function () {
    ...
    const otherSlides = project.slides.slice(1).map(function (entry, i) {
      ...
      if (entry && typeof entry === 'object' && !Array.isArray(entry)) {
        ...
        if (entry.layout === 'imageshow') {
          var arrowSvg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62.53 32.84" aria-hidden="true"><path d="M62.53,15.08v-.94c-7.91-.05-14.11-6.4-14.11-14.14h-4.77c0,1.43.16,3.19.71,5.15,1.25,4.49,3.86,7.46,5.42,8.98H0v4.6h49.77c-1.56,1.51-4.17,4.49-5.42,8.98-.55,1.95-.7,3.72-.71,5.14h4.77c0-7.65,6.07-13.94,13.86-14.12h.25v-3.64h0Z"/></svg>';
  ...
  // -----------------------------------------------------------
  var arrowSvgStr = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62.53 32.84" aria-hidden="true"><path d="M62.53,15.08v-.94c-7.91-.05-14.11-6.4-14.11-14.14h-4.77c0,1.43.16,3.19.71,5.15,1.25,4.49,3.86,7.46,5.42,8.98H0v4.6h49.77c-1.56,1.51-4.17,4.49-5.42,8.98-.55,1.95-.7,3.72-.71,5.14h4.77c0-7.65,6.07-13.94,13.86-14.12h.25v-3.64h0Z"/></svg>';
